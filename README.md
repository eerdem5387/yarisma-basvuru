# 🎯 Yarışma Başvuru Sistemi

Modern ve güvenli bir yarışma başvuru sistemi. Next.js 15, TypeScript, Prisma ve Neon Database ile geliştirilmiştir.
...
\`app/page.tsx\` dosyasındaki \`okullar\`, \`siniflar\`, \`meslekler\` ve yarışma kategorileri arraylerini düzenleyebilirsiniz.

**Mevcut Veriler:**
- 📚 **Okul Listesi** - Yarışmaya katılabilecek okullar
- 👔 **100+ Meslek** - Kapsamlı meslek listesi
- 🎓 **Sınıf Seçenekleri** - Yarışmaya uygun sınıf aralığı
